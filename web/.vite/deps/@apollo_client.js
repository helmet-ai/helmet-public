...
var DEV_default = "__DEV__" in global_default ? Boolean(global_default.__DEV__) : maybe(function() {
  return "development";
}) !== "production";
...
var ApolloLink = function() {
  ...
  ApolloLink2.concat = function(first, second) {
    ...
    if (isTerminating(firstLink)) {
      __DEV__ && invariant2.warn(34, firstLink);
      return firstLink;
    }
...
function readJsonBody(response, operation, observer) {
  parseAndCheckHttpResponse(operation)(response).then(function(result2) {
    var _a2, _b;
    (_a2 = observer.next) === null || _a2 === void 0 ? void 0 : _a2.call(observer, result2);
...
var createHttpLink = function(linkOptions) {
  ...
  return new ApolloLink(function(operation) {
    ...
    if (context.clientAwareness) {
      var _a3 = context.clientAwareness, name_1 = _a3.name, version4 = _a3.version;
      if (name_1) {
        ...
        if (supertypeSet.has(supertype)) {
          if (!typenameSupertypeSet.has(supertype)) {
            if (checkingFuzzySubtypes) {
              __DEV__ && invariant2.warn(4, typename, supertype);
            }
...
function normalizeReadFieldOptions(readFieldArgs, objectOrReference, variables) {
  ...
  if (__DEV__ && options.from === void 0) {
    __DEV__ && invariant2.warn(5, stringifyForDisplay(Array.from(readFieldArgs)));
  }
  ...
  StoreWriter2.prototype.processSelectionSet = function(_a2) {
    ...
    this.flattenFields(selectionSet, result2, context, typename).forEach(function(context2, field) {
      ...
      if (value !== void 0) {
        ...
        __DEV__ && invariant2.error(10, resultKeyNameFromField(field), result2);
      }
    });
    try {
...
function warnAboutDataLoss(existingRef, incomingObj, storeFieldName, store) {
  ...
  __DEV__ && invariant2.warn(12, fieldName, parentType, childTypenames.length ? "either ensure all objects of type " + childTypenames.join(" and ") + " have an ID or a custom merge function, or " : "", typeDotName, existing, incoming);
}
...
var ObservableQuery = function(_super) {
  ...
  ObservableQuery2.prototype.getCurrentResult = function(saveAsLastResult) {
    ...
    if (fetchPolicy === "network-only" || fetchPolicy === "no-cache" || fetchPolicy === "standby" || this.queryManager.getDocumentInfo(this.query).hasForcedResolvers) {
    } else {
  ...
  ObservableQuery2.prototype.subscribeToMore = function(options) {
    ...
    var subscription = this.queryManager.startGraphQLSubscription({
      ...
      error: function(err) {
        ...
        __DEV__ && invariant2.error(20, err);
      }
    });
...
function defaultSubscriptionObserverErrorCallback(error) {
  __DEV__ && invariant2.error(22, error.message, error.stack);
}
function logMissingFieldErrors(missing) {
  if (__DEV__ && missing) {
    __DEV__ && invariant2.debug(23, missing);
  }
}
          ...
          return __awaiter(_this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a3) {
              ...
              if (isInlineFragment(selection)) {
                ...
                invariant2(fragment, 17, selection.name.value);
              }
      ...
      if (!selectionsToResolveCache.has(definitionNode)) {
        ...
        visit(definitionNode, {
          ...
          FragmentSpread: function(spread, _, __, ___, ancestors) {
            ...
            invariant2(fragment, 18, spread.name.value);
...
var QueryManager = function() {
  ...
  QueryManager2.prototype.mutate = function(_a2) {
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_h) {
        switch (_h.label) {
          case 0:
            invariant2(mutation, 25);
            invariant2(fetchPolicy === "network-only" || fetchPolicy === "no-cache", 26);
  ...
  QueryManager2.prototype.query = function(options, queryId) {
    ...
    invariant2(options.query, 27);
    invariant2(options.query.kind === "Document", 28);
    invariant2(!options.returnPartialData, 29);
    invariant2(!options.pollInterval, 30);
  ...
  QueryManager2.prototype.getObservableQueries = function(include) {
    ...
    if (__DEV__ && queryNamesAndDocs.size) {
      queryNamesAndDocs.forEach(function(included, nameOrDoc) {
        if (!included) {
          __DEV__ && invariant2.warn(typeof nameOrDoc === "string" ? 32 : 33, nameOrDoc);
        }
      });
    }
    return queries;
...
var ApolloClient = function() {
  function ApolloClient2(options) {
    ...
    var uri = options.uri, credentials = options.credentials, headers = options.headers, cache2 = options.cache, documentTransform = options.documentTransform, _a2 = options.ssrMode, ssrMode = _a2 === void 0 ? false : _a2, _b = options.ssrForceFetchDelay, ssrForceFetchDelay = _b === void 0 ? 0 : _b, _c = options.connectToDevTools, connectToDevTools = _c === void 0 ? typeof window === "object" && !window.__APOLLO_CLIENT__ && __DEV__ : _c, _d = options.queryDeduplication, queryDeduplication = _d === void 0 ? true : _d, defaultOptions2 = options.defaultOptions, _e = options.assumeImmutableResults, assumeImmutableResults = _e === void 0 ? cache2.assumeImmutableResults : _e, resolvers = options.resolvers, typeDefs = options.typeDefs, fragmentMatcher = options.fragmentMatcher, clientAwarenessName = options.name, clientAwarenessVersion = options.version;
  ...
  ApolloClient2.prototype.query = function(options) {
    ...
    invariant2(options.fetchPolicy !== "cache-and-network", 15);
  ...
  ApolloClient2.prototype.refetchQueries = function(options) {
    ...
    result2.catch(function(error) {
      __DEV__ && invariant2.debug(16, error);
    });
    return result2;
  };
...
function getApolloContext() {
  invariant2("createContext" in React, 44);
  var contextStorage = global_default[contextKey] || (global_default[contextKey] = /* @__PURE__ */ Object.create(null));
  return contextStorage[React.version] || (contextStorage[React.version] = Object.assign(React.createContext({}), { displayName: "ApolloContext" }));
}
...
var ApolloConsumer = function(props) {
  ...
  return React2.createElement(ApolloContext.Consumer, null, function(context) {
    invariant2(context && context.client, 43);
...
var ApolloProvider = function(_a2) {
  var client = _a2.client, suspenseCache = _a2.suspenseCache, children = _a2.children;
  var ApolloContext = getApolloContext();
  var parentContext = React3.useContext(ApolloContext);
  var context = React3.useMemo(function() {
    return __assign(__assign({}, parentContext), { client: client || parentContext.client, suspenseCache: suspenseCache || parentContext.suspenseCache });
  }, [parentContext, client, suspenseCache]);
  invariant2(context.client, 45);
...
var useSyncExternalStore = realHook || function(subscribe2, getSnapshot, getServerSnapshot) {
  ...
  if (__DEV__ && !didWarnUncachedGetSnapshot && value !== getSnapshot()) {
    ...
    __DEV__ && invariant2.error(58);
  }
  var _a2 = React4.useState({ inst: { value, getSnapshot } }), inst = _a2[0].inst, forceUpdate = _a2[1];
...
function useInternalState(client, query) {
  ...
  var _a2 = (0, import_react2.useState)(0), _tick = _a2[0], setTick = _a2[1];
...
function useMutation(mutation, options) {
  ...
  var _a2 = (0, import_react4.useState)({
    called: false,
    loading: false,
    client
...
function useSubscription(subscription, options) {
  ...
  var _a2 = (0, import_react5.useState)({
  ...
  if (!hasIssuedDeprecationWarningRef.current) {
    ...
    if (options === null || options === void 0 ? void 0 : options.onSubscriptionData) {
      __DEV__ && invariant2.warn(options.onData ? 51 : 52);
    }
    if (options === null || options === void 0 ? void 0 : options.onSubscriptionComplete) {
      __DEV__ && invariant2.warn(options.onComplete ? 53 : 54);
    }
  }
...
// node_modules/@apollo/client/react/hooks/internal/useStrictModeSafeCleanupEffect.js
...
var useKey = "use";
var realHook2 = import_react11.default[useKey];
...
// node_modules/@apollo/client/react/hooks/useSuspenseCache.js
var import_react12 = __toESM(require_react(), 1);
function useSuspenseCache(override) {
  var context = (0, import_react12.useContext)(getApolloContext());
  var suspenseCache = override || context.suspenseCache;
  invariant2(suspenseCache, 55);
...
function useSuspenseQuery(query, options) {
  ...
  var watchQueryOptions = useWatchQueryOptions({ query, options });
  ...
  var _b = (0, import_react13.useState)(function() {
  ...
  (0, import_react13.useEffect)(function() {
    return queryRef.listen(function(promise2) {
  ...
  var fetchMore = (0, import_react13.useCallback)(function(options2) {
    var promise2 = queryRef.fetchMore(options2);
    setPromiseCache(function(previousPromiseCache) {
      return new Map(previousPromiseCache).set(queryRef.key, promise2);
    });
    return promise2;
  }, [queryRef]);
  var refetch = (0, import_react13.useCallback)(function(variables2) {
  ...
  var subscribeToMore = (0, import_react13.useCallback)(function(options2) {
...
function useTrackedQueryRefs(queryRef) {
  var trackedQueryRefs = (0, import_react13.useRef)(/* @__PURE__ */ new Set());
  trackedQueryRefs.current.add(queryRef);
  useStrictModeSafeCleanupEffect(function() {
    trackedQueryRefs.current.forEach(function(sub) {
      return sub.dispose();
    });
  });
}
function useWatchQueryOptions(_a2) {
  var query = _a2.query, options = _a2.options;
  var watchQueryOptions = useDeepMemo(function() {
    return __assign(__assign({}, options), { query, notifyOnNetworkStatusChange: false, nextFetchPolicy: void 0 });
  }, [options, query]);
  if (__DEV__) {
...
function useBackgroundQuery(query, options) {
  ...
  var _b = (0, import_react14.useState)(function() {
    return /* @__PURE__ */ new Map([[queryRef.key, queryRef.promise]]);
  }), promiseCache = _b[0], setPromiseCache = _b[1];
  useTrackedQueryRefs(queryRef);
  var fetchMore = (0, import_react14.useCallback)(function(options2) {
    var promise = queryRef.fetchMore(options2);
    setPromiseCache(function(promiseCache2) {
      return new Map(promiseCache2).set(queryRef.key, promise);
    });
    return promise;
  }, [queryRef]);
  var refetch = (0, import_react14.useCallback)(function(variables2) {
    var promise = queryRef.refetch(variables2);
    setPromiseCache(function(promiseCache2) {
      return new Map(promiseCache2).set(queryRef.key, promise);
    });
    return promise;
...
function useReadQuery(queryRef) {
  var _a2 = (0, import_react14.useState)(0), forceUpdate = _a2[1];
  invariant2(queryRef.promiseCache, 49);
  ...
  (0, import_react14.useEffect)(function() {
    return queryRef.listen(function(promise2) {
      queryRef.promiseCache.set(queryRef.key, promise2);
      forceUpdate(function(prevState) {
        return prevState + 1;
      });
    });
  }, [queryRef]);
...
var QueryReference = function() {
  function QueryReference2(observable, options) {
    var _this = this;
    var _a2;
    this.listeners = /* @__PURE__ */ new Set();
    ...
    if (isNetworkRequestSettled(this.result.networkStatus) || this.result.data && (!this.result.partial || this.observable.options.returnPartialData)) {
  ...
  QueryReference2.prototype.listen = function(listener) {
    var _this = this;
  ...
  QueryReference2.prototype.refetch = function(variables) {
    this.refetching = true;
    var promise = this.observable.refetch(variables);
    this.promise = promise;
    return promise;
  };
  QueryReference2.prototype.fetchMore = function(options) {
    var promise = this.observable.fetchMore(options);
    this.promise = promise;
    return promise;
  };
  QueryReference2.prototype.dispose = function() {
    this.subscription.unsubscribe();
    this.onDispose();
  };
  QueryReference2.prototype.onDispose = function() {
  };
  QueryReference2.prototype.handleNext = function(result2) {
    if (!this.initialized || this.refetching) {
      if (!isNetworkRequestSettled(result2.networkStatus)) {
        return;
      }
      if (this.result.data && result2.data === void 0) {
        result2.data = this.result.data;
      }
      this.initialized = true;
      this.refetching = false;
      this.result = result2;
      this.resolve(result2);
      return;
    }
  ...
  QueryReference2.prototype.handleError = function(error) {
    var result2 = __assign(__assign({}, this.result), { error, networkStatus: NetworkStatus.error });
    this.result = result2;
    if (!this.initialized || this.refetching) {
      this.initialized = true;
      this.refetching = false;
    ...
    this.result = result2;
    this.promise = result2.data ? createFulfilledPromise(result2) : createRejectedPromise(result2);
    this.deliver(this.promise);
  };
  QueryReference2.prototype.deliver = function(promise) {
    this.listeners.forEach(function(listener) {
